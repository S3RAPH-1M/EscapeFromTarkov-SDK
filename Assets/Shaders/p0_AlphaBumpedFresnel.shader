	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                o.sv_target.w = tmp2.w * _Color.w + _AddAlpha;
		...
		Pass {
			Name "FORWARD"
			LOD 300
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDADD" "QUEUE" = "AlphaTest+2" "RenderType" = "TransparentCutout" }
		...
		Pass {
			Name "PREPASS"
			LOD 300
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "PREPASSBASE" "QUEUE" = "AlphaTest+2" "RenderType" = "TransparentCutout" }
			Blend SrcAlpha OneMinusSrcAlpha, SrcAlpha OneMinusSrcAlpha
			ColorMask RGB -1
			ZWrite Off
			GpuProgramID 164961
			...
			fout frag(v2f inp)
			{
                ...
                o.sv_target.w = tmp0.w * _Color.w + _AddAlpha;
                return o;
			}
			ENDCG
		}
		Pass {
			Name "PREPASS"
			LOD 300
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "PREPASSFINAL" "QUEUE" = "AlphaTest+2" "RenderType" = "TransparentCutout" }
			Blend SrcAlpha OneMinusSrcAlpha, SrcAlpha OneMinusSrcAlpha
			ZWrite Off
			GpuProgramID 216237
			CGPROGRAM
			...
			fout frag(v2f inp)
			{
                ...
                o.sv_target.w = tmp1.w * _Color.w + _AddAlpha;
